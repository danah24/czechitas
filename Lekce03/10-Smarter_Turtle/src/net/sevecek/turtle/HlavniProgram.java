...
public class HlavniProgram {
   ...
   Turtle zofka;
    ...
    public void run() {
        ...
        barva2 = new Color(80, 102, 159);
        barva3 = new Color(52, 108, 43);

        zofka.setLocation(600,600);
        zofka.setPenColor(barva2);
        zofka.move(400);

        kresliCtverec(100, 100, barva1);
        kresliCtverec(200, 200, barva2);
        kresliCtverec(300, 300, barva3);

        zofka.setLocation(700, 700);
        zofka.move(400);
    }
       public void kresliCtverec(int x, int y, Color docasnaBarva) {
           Color puvodniBarva;
